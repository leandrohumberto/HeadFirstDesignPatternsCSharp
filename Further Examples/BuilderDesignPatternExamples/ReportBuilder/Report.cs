...
namespace ReportBuilder
{
    public class Report
    {
        ...
        public Report(DateTime from, DateTime to, bool includeReturnedOrders, 
            bool includeUnshippedOrders, SortingMethod sortBy)
        {
            _fromDate = from;
            _toDate = to;
        ...
        {
            return $"Report from {_fromDate.ToString("MM/dd/yyyy")} to {_toDate.ToString("MM/dd/yyyy")}";
        }
    }
}
